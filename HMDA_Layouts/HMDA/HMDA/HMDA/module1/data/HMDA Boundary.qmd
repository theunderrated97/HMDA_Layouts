...
<qgis version="3.32.3-Lima">
  <identifier>All_Villages</identifier>
  <parentidentifier></parentidentifier>
  <language>EN</language>
  <type>dataset</type>
  <title>All_Villages</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link type="Local Area Network" format="" name="File Geodatabase Feature Class" mimeType="" size="" url="file://\\LASA6\D$\GISData\Hyderabad.gdb" description=""/>
  </links>
  <dates/>
  <fees></fees>
